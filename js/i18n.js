...
const translations = {
    hr: {
        ...
        warningInvalidIban: "IBAN ne prolazi kontrolu (mod-97). Vjerojatno je tipfeler — provjerite IBAN prije plaćanja.",
        cautionNewPayee: "Novi IBAN — za njega još nije generiran bar kod. Pažljivo provjerite IBAN i naziv primatelja prije plaćanja.",
        warningIbanNameMismatch: "Ovaj IBAN već je korišten za drugog primatelja ({name}). Provjerite je li primatelj točan.",
        noticeKnownIban: "Za ovaj IBAN već ste generirali bar kod (primatelj: {name}).",
        copied: "Kopirano!",
    ...
    en: {
        ...
        warningInvalidIban: "IBAN fails its checksum (mod-97). Likely a typo — please verify the IBAN before paying.",
        cautionNewPayee: "New payee — no barcode has been generated for this IBAN before. Double-check the IBAN and payee name before paying.",
        warningIbanNameMismatch: "This IBAN was previously used for a different payee ({name}). Verify the payee before paying.",
        noticeKnownIban: "You've generated a barcode for this IBAN before (payee: {name}).",
        copied: "Copied!",
